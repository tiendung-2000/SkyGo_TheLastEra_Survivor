...
namespace MagneticScrollView
{
    ...
    public class MagneticScrollRect : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        //[SerializeField, Range (0f, 1000f)] public float m_elementPadding = 0f;
        [SerializeField] public float m_elementPadding = 0f;
        ...
        [SerializeField] public float m_circularFactor = 0f;
        ...
        public void StartScrolling(bool inertiaEnd = false)
        {
        ...
        public void OnPointerDown(PointerEventData ped)
        {
            ...
            if (ped.button != PointerEventData.InputButton.Left || !RectTransformUtility.RectangleContainsScreenPoint(rectArea, ped.position, ped.pressEventCamera) || ped.pointerId > 0)
                return;
