    ...
    public class IndexTableManager : MonoBehaviour
    {
        ...
        public void MoveIndicator(int index, bool invertOrder)
        {
            if (indicator != null && transform.childCount > index && transform.GetChild(index) != null)
            {
                ...
                //DynamicDataManager.Ins.CurPlayer = index;
                //if(!isLevelOrPlayer)
                //    DynamicDataManager.Ins.CurLevel = index;
                //else
                //{
                //DynamicDataManager.Ins.CurPlayer = index;
                //DynamicDataManager.Ins.UpdateCurPlayerUpgrade();
                //DynamicDataManager.Ins.UpdateCurCoolDownUpgrader();
